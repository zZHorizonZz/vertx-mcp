...
public class ModelHint {
  ...
  /**
   * Gets a hint for a model name. The client SHOULD treat this as a substring of a model name; for example: - "claude-3-5-sonnet" should match "claude-3-5-sonnet-20241022" -
   * "sonnet" should match "claude-3-5-sonnet-20241022", "claude-3-sonnet-20240229", etc. - "claude" should match any Claude model
   * <p>
   * The client MAY also map the string to a different provider's model name or a different model family, as long as it fills a similar niche; for example: - "gemini-1.5-flash"
