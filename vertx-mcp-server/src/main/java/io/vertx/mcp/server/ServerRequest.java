...
public interface ServerRequest extends ReadStream<JsonObject> {

  void init(ServerResponse response);

  /**
   * Get the request path for routing.
   * This returns the JSON-RPC method field from the parsed request.
   *
  ...
  /**
   * Get the parsed JSON-RPC request.
   * This is only available after the request has been fully read and parsed.
   *
  ...
  /**
   * Set the parsed JSON-RPC request.
   * This is typically called by the transport layer after parsing the request.
   *
