...
public class ServerOptions {
   ...
   * <p>
   * When enabled, the server will accept and process notification messages from clients.
   * When disabled, notification messages will be ignored.
   *
   ...
   * <p>
   * Sessions that remain inactive for this duration will be automatically closed
   ...
   * until existing sessions are closed.
   *
