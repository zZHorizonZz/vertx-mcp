...
/**
 * Represents a handler responsible for providing dynamic resources. A dynamic resource handler provides resources based on URI template patterns, where the handler receives a map
 * of extracted URI template variables.
 *
 * @version 2025-06-18
