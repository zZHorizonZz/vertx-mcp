...
public interface ServerResponse extends WriteStream<JsonObject> {
  ...
  /**
   * End the response with 202 Accepted status. This is used for notifications which don't expect a JSON-RPC response.
   *
  ...
  /**
   * Get the session associated with this response. Sessions are used to track SSE connections and streaming state.
   *
