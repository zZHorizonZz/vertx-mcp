...
/**
 * Interface for server features that can provide completion suggestions.
 * Features implementing this interface will be queried by the CompletionServerFeature
 * when completion requests are received for their supported reference types.
 *
 * @version 2025-06-18
