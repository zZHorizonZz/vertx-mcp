...
/**
 * Represents the client response in a JSON-RPC framework. This interface provides mechanisms for accessing and managing JSON-RPC responses and
...
public interface ClientResponse {
  ...
  /**
   * Initializes the client response with the given session and client request. This method associates the response with a specific session and request,
   * allowing state and connections to be managed.
   *
